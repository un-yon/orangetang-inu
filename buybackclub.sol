...
contract BuybackClub is IERC20, Ownable {
    ...
    uint8 public constant buyFee = 5;
    uint8 public constant sellFee = 10;
    ...
    function setMinimumTokensBeforeSwap(uint256 newValue) external onlyOwner {
        ...
        require(newValue <= _totalSupply * 1 / 100, string.concat(_name, ": cannot update minimumTokensBeforeSwap to more than 1%."));
